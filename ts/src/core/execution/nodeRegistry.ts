...
import { ExpressServiceNode } from "./nodes/expressService";
import { AutotraderStatsListenerNode } from "./nodes/autotraderStatsListener";
import { ClankerAutotraderStatsNode } from "./nodes/clankerAutotraderStats";
import { SellBagsListenerNode } from "./nodes/sellBagsListener";
import { SellAllBagsNode } from "./nodes/sellAllBags";
import { ActionLoggerNode } from "./nodes/actionLogger";
...
import { LpFillOrderListenerNode } from "./nodes/lpFillOrderListener";
import { PolymarketLpFillOrderNode } from "./nodes/polymarketLpFillOrder";
import { MulticallStubNode } from "./nodes/multicallStub";
...
export function registerAllNodes(): void {
  ...
  registerNode("express_service", ExpressServiceNode);
  registerNode("autotrader_stats_listener", AutotraderStatsListenerNode);
  registerNode("clanker_autotrader_stats", ClankerAutotraderStatsNode);
  registerNode("sell_bags_listener", SellBagsListenerNode);
  registerNode("sell_all_bags", SellAllBagsNode);
  registerNode("action_logger", ActionLoggerNode);
  ...
  registerNode("lp_fill_order_listener", LpFillOrderListenerNode);
  registerNode("polymarket_lp_fill_order", PolymarketLpFillOrderNode);
  registerNode("multicall_stub", MulticallStubNode);
