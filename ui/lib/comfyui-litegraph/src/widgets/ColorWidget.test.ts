...
import type { LGraphNode as LGraphNodeType } from '../litegraph'
import type { CanvasPointerEvent } from '../types/events'
import type { IColorWidget } from '../types/widgets'
import type { ColorWidget as ColorWidgetType } from '../widgets/ColorWidget'
...
describe('ColorWidget', () => {
  ...
  beforeEach(async () => {
    ...
    const colorWidgetModule =
      await import('../widgets/ColorWidget')
